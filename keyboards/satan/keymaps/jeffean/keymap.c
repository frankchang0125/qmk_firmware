...
[_DEF] = KEYMAP_ANSI(
   ...
   KC_LCTL,  GRV_LALT, GRV_LGUI,                               KC_SPC,                                 GUI_DUAL, W_MIN,    KC_LEFT,  CLN_DUAL  ),
...
[_SFT] = KEYMAP_ANSI(
   ...
   S(KC_TAB), S(KC_HOME), S(KC_UP),   S(KC_PGUP), S(KC_R),  S(KC_T),  S(KC_Y),  S(KC_U),  S(KC_I),  S(KC_O),    S(KC_P),    S(KC_LBRC), S(KC_RBRC), S(KC_BSLS), \
   KC_LCTL,   S(KC_LEFT), S(KC_DOWN), S(KC_RGHT), S(KC_F),  S(KC_G),  S(KC_H),  S(KC_J),  S(KC_K),  S(KC_L),    S(KC_SCLN), S(KC_QUOT),             ________,   \
   ________,              S(KC_END),  S(KC_PGDN), S(KC_C),  S(KC_V),  S(KC_B),  S(KC_N),  S(KC_M),  S(KC_COMM), S(KC_DOT),  S(KC_SLSH),             ________,   \
   ________,  ________,   ________,                                   SW_FOCUS,                                 S(KC_HOME), S(KC_LEFT), S(KC_RGHT), S(KC_END)   ),

[_CTL] = KEYMAP_ANSI(
   C(KC_GRV), C(KC_1),    C(KC_2),    C(KC_3),    C(KC_4),  C(KC_5),  C(KC_6),  C(KC_7),  C(KC_8),  C(KC_9),    C(KC_0),    C(KC_MINS), C(KC_EQL),  C(KC_BSPC), \
   L_ORW,     C(KC_Q),    C(KC_W),    C(KC_E),    C(KC_R),  C(KC_T),  KC_END,   KC_PGDN,  KC_PGUP,  KC_HOME,    C(KC_P),    C(KC_LBRC), C(KC_RBRC), C(KC_BSLS), \
...
[_ARW] = KEYMAP_ANSI(
   ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, ________, \
   ________, KC_7,     KC_8,     KC_9,     ________, ________, KC_END,   KC_PGDN,  KC_PGUP,  KC_HOME,  ________, ________, ________, ________, \
